...
function FetchData (props){
    ...
    useEffect(() => {
        let uri = 'https://www.udemy.com/api-2.0/courses/?search='+props.filter +'&fields[course]=@all&page_size=15';
        let h= new Headers();
        h.append("Accept","application/json, text/plain, */*");
        // enviroment variable react
    ...
    courses = data;
    console.log(courses);
    return (data[0] && <h1>{data[0].id} alooooo</h1>);
}
